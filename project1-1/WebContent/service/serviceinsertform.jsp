...
<div class="wrapper">
	...
	<form action="serviceinsert.do" method="post" onsubmit="return checked();">
	  ...
	  <div class="form-group">
	  <p><strong>질문유형선택</strong></p>
		  <label class="radio-inline">
		    <input type="radio" name="type" value="상품"><span>상품</span>
		  </label>
		  <label class="radio-inline">
		    <input type="radio" name="type" value="회원정보"><span>회원정보</span>
		  </label>
		  <label class="radio-inline">
		    <input type="radio" name="type" value="A/S"><span>A/S</span>
		  </label>
		  <label class="radio-inline">
		    <input type="radio" name="type" value="서비스"><span>회원혜택/서비스</span>
		  </label>
		  <label class="radio-inline">
		    <input type="radio" name="type" value="배송"><span>배송</span>
		  </label>
		  <label class="radio-inline">
		    <input type="radio" name="type" value="주문결제"><span>주문결제</span>
		  </label>
	  </div>
